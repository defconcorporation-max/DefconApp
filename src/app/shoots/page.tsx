        ...
        <main className="min-h-screen p-4 md:p-8 pt-20 md:pt-8 pb-20">
            <header className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4 border-b border-[var(--border-subtle)] pb-6">
                <div>
                    ...
                    <p className="text-[var(--text-tertiary)] text-sm">Manage your production schedule and upcoming shoots.</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {shoots.map(shoot => (
                    <Link href={`/shoots/${shoot.id}`} key={shoot.id} className="group">
                        <div className="pro-card p-6 h-full hover:border-violet-500/30 transition-all duration-300">
