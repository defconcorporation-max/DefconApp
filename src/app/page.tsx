  ...
  return (
    <main className="min-h-screen p-8">
      <header className="flex flex-col md:flex-row justify-between items-center mb-8 gap-6 pb-6 border-b border-[var(--border-subtle)]">
        ...
        <form action={createClient} className="flex gap-2 items-center bg-[var(--bg-surface)] p-1.5 rounded-lg border border-[var(--border-subtle)]">
          <input name="name" placeholder="Name" className="bg-transparent border-none text-sm px-3 py-1 focus:outline-none text-white w-32 placeholder:text-[var(--text-tertiary)]" required />
          <div className="w-px h-4 bg-[var(--border-subtle)]"></div>
          <input name="company" placeholder="Company" className="bg-transparent border-none text-sm px-3 py-1 focus:outline-none text-white w-32 placeholder:text-[var(--text-tertiary)]" />
          <div className="w-px h-4 bg-[var(--border-subtle)]"></div>
          <select name="plan" className="bg-transparent border-none text-xs px-2 text-[var(--text-secondary)] focus:outline-none w-24 appearance-none">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <div className="bg-[#0A0A0A] border border-[var(--border-subtle)] p-4 rounded-xl relative overflow-hidden group">
          ...
          <p className="text-xs text-[var(--text-secondary)] uppercase tracking-wider mb-1">Cash Collected</p>
          <div className="text-2xl font-bold text-white flex items-end gap-2">
            ${stats.totalRevenue.toLocaleString()}
            <span className="text-xs font-normal text-emerald-400 mb-1">+12%</span>
          </div>
        </div>
        ...
        <div className="bg-[#0A0A0A] border border-[var(--border-subtle)] p-4 rounded-xl relative overflow-hidden group">
          ...
          <p className="text-xs text-[var(--text-secondary)] uppercase tracking-wider mb-1">Unpaid Invoices</p>
          <div className="text-2xl font-bold text-white flex items-end gap-2">
        ...
        <div className="bg-[#0A0A0A] border border-[var(--border-subtle)] p-4 rounded-xl relative overflow-hidden group">
          ...
          <p className="text-xs text-[var(--text-secondary)] uppercase tracking-wider mb-1">Active Clients</p>
          <div className="text-2xl font-bold text-white flex items-end gap-2">
            {stats.activeClients} <span className="text-sm font-normal text-[var(--text-tertiary)]">/ {stats.totalClients}</span>
          </div>
        </div>
        ...
        <div className="bg-[#0A0A0A] border border-[var(--border-subtle)] p-4 rounded-xl relative overflow-hidden group">
          ...
          <p className="text-xs text-[var(--text-secondary)] uppercase tracking-wider mb-1">Upcoming Shoots</p>
          <div className="text-2xl font-bold text-white flex items-end gap-2">
