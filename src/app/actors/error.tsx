...
export default function ActorsError({ error, reset }: { error: Error; reset: () => void }) {
    return (
        <main className="min-h-screen flex items-center justify-center p-6">
            <div className="text-center max-w-md">
                ...
                <div className="flex gap-3 justify-center">
                    ...
                    <Link href="/" className="px-4 py-2 border border-[var(--border-subtle)] text-sm rounded hover:bg-white/5 transition-colors text-white">
                        Go Home
                    </Link>
                </div>
            </div>
